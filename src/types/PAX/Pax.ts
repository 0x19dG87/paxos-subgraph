...
export class ReclaimPAXCall extends ethereum.Call {
  get inputs(): ReclaimPAXCall__Inputs {
    return new ReclaimPAXCall__Inputs(this);
  }

  get outputs(): ReclaimPAXCall__Outputs {
    return new ReclaimPAXCall__Outputs(this);
  }
}

export class ReclaimPAXCall__Inputs {
  _call: ReclaimPAXCall;

  constructor(call: ReclaimPAXCall) {
    this._call = call;
  }
}

export class ReclaimPAXCall__Outputs {
  _call: ReclaimPAXCall;
